...
```
I will give you some expressions. Please replace the bold word with the simplest appropriate word. For example: in “**pooling** demand,” replace “pooling” with a very simple but suitable word.
```
